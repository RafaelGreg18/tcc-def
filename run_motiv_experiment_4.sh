...
#lrc
flwr run . gpu-sim-lrc --run-config="seed=1 dir-alpha=0.1 num-rounds=200 model-name='simplecnn'"
flwr run . gpu-sim-lrc --run-config="seed=1 participants-name='recombination' dir-alpha=0.1 num-rounds=200 model-name='simplecnn'"
