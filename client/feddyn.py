...
from utils.model.manipulation import set_weights, get_weights, test, train_feddyn


class BaseFedDynClient(BaseClient):
    ...
    def fit(
        ...
        if int(config["server_round"]) == 1:
            ...
            avg_loss, avg_acc, stat_util, self.prev_grads = train_feddyn(self.model, self.dataloader, epochs, criterion,
